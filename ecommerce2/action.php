			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>USD $pro_price.00/-
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<div class="row">
							...
							<thead>
							<form name="form1" id="form1" action="/actionwae.php"><fieldset>
							<legend><center>DELIVERY ADDRESS</center></legend>
							...
							<thead>
		        				<th>Full Address :</th>	<br><br>
							</thead>
							<thead>
								<th>								
								<textarea name="message" rows="5" cols="90">Type Here Your Full Address. Then Checkout Through Paypal Button</textarea>
								<br><br>						
